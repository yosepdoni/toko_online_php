...
$ordershistory = mysqli_query($conn,"SELECT * FROM ordershistory");
$ordershistory = mysqli_num_rows($ordershistory);
$user = mysqli_query($conn,"SELECT * FROM users");
$user = mysqli_num_rows($user);
?>
<?php
include ('../koneksi.php');
$conn=mysqli_query($conn," SELECT * FROM ordershistory");
while($h=mysqli_fetch_array($conn)){
?>
<p hidden>  
<?="Rp".number_format($total[] =$h['total'],0,",",".");?>
